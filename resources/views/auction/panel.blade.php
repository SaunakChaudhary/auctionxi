    ...
    <div class="page-header">
        ...
        <div class="ap-header-row">
            ...
            <div class="ap-header-actions">
                ...
                <a href="{{ route('auction.results', $tournament->id) }}" class="ap-btn ap-btn-results">
            ...
            <div class="ap-panel-card">
                ...
                <div class="ap-panel-body">
                    ...
                    <div class="ap-search-wrap">
                        ...
                        <button type="button" id="btnClear" class="ap-clear-btn" title="Clear">
                    ...
                    <div class="ap-nav-bar">
                        <button type="button" id="btnPrev" class="ap-nav-btn" disabled>
                    ...
                    {{-- ── EMPTY STATE ── --}}
                    <div id="stateEmpty" class="ap-state" style="{{ $totalPlayers > 0 ? 'display:none;' : '' }}">
                        <div class="ap-state-icon">🏏</div>
                    ...
                    <div id="playerCard" style="{{ $firstPlayer ? '' : 'display:none;' }}">
                        ...
                        <div id="assignedWarning" class="ap-assigned-warn"
                            ...
                            <button type="button" id="btnOpenEdit" class="ap-btn-edit-assign">
                        ...
                        <div class="ap-assign-form" id="assignForm">
                            ...
                            <div class="ap-form-row">
                                ...
                                <div class="ap-form-group" id="priceGroup">
                                    ...
                                    <input type="number" id="soldPrice" class="ap-input" placeholder="Enter bid amount"
                                        min="0"
                            ...
                            <div id="teamSection">
                                ...
                                <div class="ap-team-grid" id="teamGrid">
                                    @forelse($tournament->teams as $team)
                                        <div class="ap-team-card" data-team-id="{{ $team->id }}"
                            ...
                            {{-- Hidden fields --}}
                            <input type="hidden" id="selectedPlayerId" value="{{ $firstPlayer->id ?? '' }}">
                            <input type="hidden" id="selectedTeamId" value="">
                            <input type="hidden" id="selectedTeamRemaining" value="0">

                            {{-- Assign Button --}}
                            <button type="button" id="btnAssign" class="ap-assign-btn">
        ...
        <div class="ap-right">
            ...
            <div class="ap-side-card">
                <div class="ap-side-header">
                    ...
                    <a href="{{ route('auction.results', $tournament->id) }}" class="ap-side-link">View All</a>
                </div>
                @php
    ...
    <div id="editModal" class="ap-modal-overlay" style="display:none;">
        <div class="ap-modal">
            <div class="ap-modal-header">
                ...
                <button type="button" id="btnCloseModal" class="ap-modal-close">
                    <i class="bi bi-x-lg"></i>
                </button>
            </div>
            <div class="ap-modal-body">
                ...
                <div class="ap-modal-form-row">
                    ...
                    <div class="ap-form-group" id="editPriceGroup">
                        ...
                        <input type="number" id="editSoldPrice" class="ap-input" placeholder="Corrected price"
                            min="0">
                    </div>
                </div>
            ...
            <div class="ap-modal-footer">
                <button type="button" id="btnCancelModal" class="ap-btn ap-btn-ghost">Cancel</button>
                <button type="button" id="btnSaveEdit" class="ap-btn ap-btn-live">
                    <i class="bi bi-check-circle-fill"></i>
                    Save Changes
                </button>
            </div>
...
@push('styles')
    <style>
       ...
       ═══════════════════════════════════════════ */
        ...
        .ap-stat-total .ap-stat-num {
            color: var(--ap-primary);
        }

        .ap-stat-sold .ap-stat-num {
            color: var(--ap-green-lt);
        }

        .ap-stat-unsold .ap-stat-num {
            color: var(--ap-red);
        }

        .ap-stat-remaining .ap-stat-num {
            color: var(--ap-amber);
        }
        ...
        .ap-assigned-warn-text i {
            font-size: 1rem;
            flex-shrink: 0;
        }

        .ap-assigned-warn-text strong {
            font-weight: 700;
        }

        .ap-assigned-warn-text span {
            color: #b45309;
        }
...
@push('scripts')
    ...
    `).join('');
        ...
        async function doAssign() {
            ...
            // Validation
            if (!playerId) {
                showErrorToast('No player loaded. Search first.');
                return;
            }
            ...
            if (status === 'sold' && price <= 0) {
                showErrorToast('Please enter a valid bid price.');
                return;
            }
            if (status === 'sold' && price > selectedRemaining) {
                showBudgetAlert('Cannot assign — budget exceeded!');
                return;
            }
